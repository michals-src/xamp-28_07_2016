...
<div class="center-block">
	...
	<p class="alert alert-info hidden"> 
		<?php smuzform_translate_e( '+ Brak pół - Dodaj nowe pola z listy' ) ?>
	</p>
...
<div class="saveFormBtn">
	<a class="button btn-primary btn-large" id="saveForm">Zapisz formularz</a>	
</div>

<?php else: ?>

<div class="createFormBtn">
	<a class="button btn-primary btn-large" id="saveForm">Stwórz formularz</a>
</div>
