    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapseRules<%= cssID %>">
          <?php smuzform_translate_e( 'Warunki logiczne' ) ?>
        </a>
      </h4>
    </div>
    <div id="collapseRules<%= cssID %>" class="panel-collapse collapse">
      <div class="panel-body">
        ...
        <div id="ruleBuilderCont">
          ...
          <label><input type="checkbox" id="enableConditionalLogic" <% if ( ruleEnabled === true ) { %> <%- 'checked' %> <% } %> /> <?php smuzform_translate_e( 'Włączone' ) ?></label>
          ...
          <ul id="rules">
            ...
            <li>
              ...
              <div class="rule">
                ...
                <div class="ruleInlineCont">
                  <input type="text" value="<%- rules.cmpValue %>" id="ruleFieldLogicValue" placeholder="Wprowadź wartość porównawczą" />

                  <select id="ruleFieldAction">

                    <option <% if ( rules.action === 'show' ) { %> <%- 'selected' %> <% } %> value="show">Pokaż</option>
                    <option <% if ( rules.action === 'hide' ) { %> <%- 'selected' %> <% } %> value="hide">Ukryj</option>
      ...
      <div class="panel-footer">
        <small>Jeżeli to pole jest *wymagane logic może nie działać.</small>
      </div>
