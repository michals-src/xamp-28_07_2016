	...
	<div class="form-group">
		...
		<div class="row addressFieldRow">
			...
			<div class="form-group">
				...
				<label for="<%- cssID %>" class="nameFieldLabelInline"><?php smuzform_translate_e( 'Ulica' ) ?></label>
			</div>
			...
			<div class="form-group">
				...
				<label for="<%- cssID %>" class="nameFieldLabelInline"><?php smuzform_translate_e( 'Adres 2' ) ?></label>
			</div>
		...
		<div class="row addressFieldRow">
			...
			<div class="form-group col-xs-4">
				...
				<label for="<%- cssID %>" class="nameFieldLabelInline"><?php smuzform_translate_e( 'Miasto' ) ?></label>
			</div>
			...
			<div class="form-group col-xs-4">
				...
				<label for="<%- cssID %>" class="nameFieldLabelInline"><?php smuzform_translate_e( 'Województwo / Gmina' ) ?></label>
			</div>
		...
		<div class="row addressFieldRow">
			...
			<div class="form-group col-xs-4">
				...
				<label for="<%- cssID %>" class="nameFieldLabelInline"><?php smuzform_translate_e( 'Kod pocztowy' ) ?></label>
			</div>
			...
			<div class="form-group col-xs-4">
				...
				<label for="<%- cssID %>" class="nameFieldLabelInline"><?php smuzform_translate_e( 'Kraj' ) ?></label>
			</div>
