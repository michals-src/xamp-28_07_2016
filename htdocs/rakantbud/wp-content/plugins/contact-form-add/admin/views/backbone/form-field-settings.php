...
<% if ( type !== 'sectionbreak' && type !== 'linebreak' && type !== 'customText' && type !== 'customHtml' && type !== 'customImage' && type !== 'customLink' && type !== 'pagebreak'  ) { %>
	<div class="form-group">
		<label for="fieldLabel"><?php smuzform_translate_e('Nagłówek') ?></label>
	...
	<div class="form-inline">
		...
		<div class="form-group field-cont-type">
			<label for="fieldType"><?php smuzform_translate_e('Typ pola') ?></label>

			<select id="fieldType" class="form-control" disabled>
				<option value="singletext" <% if ( type === 'singletext' ) { %> <%- 'selected' %> <% } %>>Linia z tekstem</option>
				<option value="textarea" <% if ( type === 'textarea' ) { %> <%- 'selected' %> <% } %>>Text Area</option>
				<option value="number" <% if ( type === 'number' ) { %> <%- 'selected' %> <% } %>>Pole numerowe</option>
		...
		<div class="form-group field-cont-size">
			<label for=""><?php smuzform_translate_e('Rozmiar pola') ?></label>
			<select id="fieldSize" class="form-control">
				<option value="small" <% if ( size === 'small' ) { %> <%- 'selected' %> <% } %> >Małe</option>
				<option value="medium" <% if ( size === 'medium' ) { %> <%- 'selected' %> <% } %> >Średnie</option>
				<option value="large" <% if ( size === 'large' ) { %> <%- 'selected' %> <% } %> >Duże</option>
			</select>
		</div>
