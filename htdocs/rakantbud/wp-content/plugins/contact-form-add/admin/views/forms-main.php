...
<div id="forms_page_cont">
	...
	<h1 id="wp_smf_heading" class="wp_smf_heading">Formularze</h1>
	...
	<table border="0" id="smf_forms_table">
		...
		<?php if ( ! $forms ) : ?>
			...
			<div id="noSlidesMessage" style="text-align: center">
				<h3>
					Brak formularzy. Kliknij + <a href="<?php echo admin_url('admin.php?page=smuz-forms&new_post=1') ?>">Dodaj nowy formularz</a>, aby stworzyć pierwszy formularz.
				</h3>
			</div>
...
<br />
<p class="description">*Umieść shortcode w treści atrtykułu lub strony, aby zobaczyć formularz.</p>
...
jQuery('.wp_smf_delete_img').click(function() {
		...
		if ( confirm( 'Jesteś pewien, że chcesz usunąć ten formularz ? ' ) ) {
