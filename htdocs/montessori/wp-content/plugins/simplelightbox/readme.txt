...
= 1.10.0 =
* Added simplelightbox.js (1.10.0) with new options and bugfixing

= 1.9.0 =
* Added simplelightbox.js (1.9.0)

= 1.8.2.1 =
* Removing Debug

= 1.8.2 =
* Bugfixing for checkboxes not beeing saved in Wordpress Admin.

= 1.8.1 =
* Added simplelightbox.js (1.8.5) with new options and bugfixing

= 1.8.0 =
* Added simplelightbox.js (1.8.2) with new options and bugfixing

= 1.7.0 =
* Added simplelightbox.js (1.7.2) with new options and bugfixing
