...
if ( ! class_exists( 'PBSIcons' ) ) {
	...
	class PBSIcons {
		...
		public function localize_scripts( $params ) {
			$params['icon_nonce'] = wp_create_nonce( 'icon_search' );
