...
if ( ! class_exists( 'PageBuilderSandwich' ) ) {
	...
	class PageBuilderSandwich {
		...
		public static function is_editable_by_user() {
			...
			return apply_filters( 'pbs_is_editable_by_user', $editable );
		}
		...
		public function add_edit_admin_bar_button( $wp_admin_bar ) {
			...
			if ( PBS_IS_PRO ) {
				$args = array(
					...
					'title' => '<span class="ab-icon"></span>' . __( 'CSS', PAGE_BUILDER_SANDWICH ),
					'href'  => '#',
					'meta'  => array( 'class' => 'pbs-adminbar-icon pbs-adminbar-right' ),
				);
				$wp_admin_bar->add_node( $args );
				$args = array(
					...
					'title' => '<span class="ab-icon"></span>' . __( 'Javascript', PAGE_BUILDER_SANDWICH ),
					'href'  => '#',
					'meta'  => array( 'class' => 'pbs-adminbar-icon pbs-adminbar-right' ),
				);
				$wp_admin_bar->add_node( $args );
				$args = array(
					...
					'title' => '<span class="ab-icon"></span>' . __( 'Source', PAGE_BUILDER_SANDWICH ),
					'href'  => '#',
					'meta'  => array( 'class' => 'pbs-adminbar-icon pbs-adminbar-right' ),
				);
				$wp_admin_bar->add_node( $args );
