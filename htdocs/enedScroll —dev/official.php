		...
		<div class="scene-2">
				...
				<div class="_cot-small">
						...
						<div class="links">
							...
							<a href="#"> <button>Documentation</button> </a>
						</div>
			...
			<div class="bpc-c">
				<div class="ghost-box">
					...
					<div class="ghost-content">
						<!-- TEXT ; BLOCK ; CALLING ANIMATION ; SCREEN ; PIN ; SHOW (IN OUT) ; EVENTS -->
						<h4 class="title"> Text </h4>
						<ul class="horizontal">
						
							<li><a href="/demos/text/translate.html"> Translate </a></li>
						...
						<ul class="horizontal">
							...
							<li><a href="/demos/text/translate.html"> Add items </a></li>
							<li><a href="/demos/text/scale.html"> Moving items </a></li>
							<li><a href="/demos/text/spacing.html"> Changing items color </a></li>
						
						</ul>
						<h4 class="title"> Block </h4>
						<ul class="horizontal">
						
							<li><a href="/demos/text/translate.html"> Rotate </a></li>
							<li><a href="/demos/text/scale.html"> Changing size </a></li>
							<li><a href="/demos/text/spacing.html"> Moving </a></li>
							<li><a href="/demos/text/spacing.html"> Changing rounding </a></li>
...
<!-- 
		...
		<script type="text/javascript" src="official.js"></script>
